...
export declare type Reduce<T> = T extends {
    (): infer R;
} ? R : never;
...
export declare type Generic1<R extends TypeFamily<Kind1>, T1> = R & Carrier1<T1>;
export declare type Generic2<R extends TypeFamily<Kind2>, T1, T2> = R & Carrier2<T1, T2>;
export declare type Generic3<R extends TypeFamily<Kind3>, T1, T2, T3> = R & Carrier3<T1, T2, T3>;
export declare type Generic4<R extends TypeFamily<Kind4>, T1, T2, T3, T4> = R & Carrier4<T1, T2, T3, T4>;
export declare namespace Generic {
    /**
     * A marker symbol for associating values of `T<A>` to `Generic<TRepr, A>`.
     */
    const Type1: unique symbol;
    const Type2: unique symbol;
    const Type3: unique symbol;
    const Type4: unique symbol;
}
/**
